...
import { SMALL_IMG_BASE_URL, ORIGINAL_IMG_BASE_URL, MOVIE_CATEGORIES, TV_CATEGORIES } from '../utils/constants.js'
            ...
            <div className='relative h-screen text-white '>
                ...
                <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
                    ...
                    <div className='flex mt-8'>
                        <Link to={`/watch/${trendingContent?.id}`}className='bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded mr-4 items-center flex'>
